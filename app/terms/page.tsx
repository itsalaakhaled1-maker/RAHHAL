export const metadata = {
  title: "الشروط والأحكام | رحال",
  description: "شروط وأحكام استخدام موقع رحال - مخطط الرحلات الذكي",
};
        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              مرحباً بك في رحال. هذه الشروط والأحكام (&quot;الاتفاقية&quot;) تحكم استخدامك لموقع رحال وتطبيقاته وخدماته (&quot;الخدمات&quot;). باستخدامك لخدماتنا، فإنك توافق على الالتزام بهذه الشروط. إذا كنت لا توافق على أي جزء من هذه الاتفاقية، يُرجى عدم استخدام خدماتنا.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-3">2. تعريفات</h2>
            <ul className="list-disc list-inside space-y-1 text-gray-600 dark:text-gray-300">
              ...
              <li><strong>&quot;الخدمات&quot;:</strong> موقع رحال وتطبيقاته وكافة الميزات المقدمة (بحث رحلات، فنادق، خطط يومية).</li>
              <li><strong>&quot;الرحلة&quot;:</strong> الخطة السفرية التي يتم إنشاؤها عبر خدماتنا.</li>
              <li><strong>&quot;الاشتراك&quot;:</strong> الخطة المدفوعة التي يختارها المستخدم للوصول للميزات المتقدمة.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-3">3. الأهلية والتسجيل</h2>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-600 dark:text-gray-300">
              ...
              <li>المعلومات التي تقدمها أثناء التسجيل دقيقة وكاملة ومحدثة.</li>
              <li>تحافظ على سرية بيانات اعتماد حسابك (اسم المستخدم وكلمة المرور).</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-3">4. الاشتراكات والدفع</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-3">5. سياسة الاسترداد</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              يرجى مراجعة <a href="/refund" className="text-ocean hover:underline">سياسة الاسترداد</a> الخاصة بنا للاطلاع على شروط وإجراءات إرجاع الأموال.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-3">6. حقوق الملكية الفكرية</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-2">
              <strong>ملكية الشركة:</strong> جميع المحتويات والتصميمات والشعارات والبرمجيات والتقنيات المستخدمة في خدماتنا هي ملكية حصرية لشركة حكيم.
            </p>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-2">
              <strong>ملكية المستخدم:</strong> أنت تحتفظ بحقوق الملكية الفكرية للخطط السفرية التي تنشئها عبر خدماتنا. ومع ذلك، تمنحنا ترخيصاً غير حصري لاستخدام هذا المحتوى لأغراض تحسين خدماتنا.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-3">7. الاستخدام المسموح به</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-2">
              يجوز لك استخدام خدماتنا للتخطيط للرحلات الشخصية والعائلية. يُحظر عليك:
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-600 dark:text-gray-300">
              ...
              <li>استخدام الخطط السفرية المُنشأة لأغراض تجارية بدون ترخيص.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-3">8. دقة المعلومات</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              نسعى لتقديم معلومات دقيقة عن الرحلات والفنادق والوجهات. ومع ذلك، المعلومات المقدمة (أسعار، توفر، مواعيد) قد تتغير وقد لا تكون دقيقة بنسبة 100%. ننصحك بالتحقق من جميع التفاصيل مباشرة مع مزودي الخدمة (شركات الطيران، الفنادق) قبل الحجز النهائي.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-3">9. إلغاء الاشتراك</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-3">10. إنهاء الخدمة</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-3">11. إخلاء المسؤولية</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              يتم توفير خدماتنا &quot;كما هي&quot; دون أي ضمانات صريحة أو ضمنية. نحن وسيط تقني فقط ولسنا مسؤولين عن:
            </p>
            <ul className="list-disc list-inside space-y-1 text-gray-600 dark:text-gray-300">
              <li>تغييرات الأسعار أو الإلغاءات من شركات الطيران أو الفنادق.</li>
              <li>جودة الخدمات المقدمة من أطراف ثالثة.</li>
              <li>أي خسائر مالية أو شخصية ناتجة عن استخدام خطط السفر المُنشأة.</li>
              <li>تأخيرات أو إلغاءات الرحلات من مزودي الخدمة.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-3">12. القانون الساري</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-3">13. التعديلات</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
